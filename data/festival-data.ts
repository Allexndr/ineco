...
export const festivalZones: Zone[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        time: '12:00-16:00',
        duration: '240 мин',
        description: 'Создание домиков и кормушек для птиц из природных материалов',
        speaker: 'Мастера-ремесленники',
        type: 'workshop'
      }
    ]
  },
  ...
  },
  {
    ...
    activities: [
      ...
      {
        id: 'art-2',
        title: 'Рисование яблони Зиверса',
        time: '14:00-16:00',
        duration: '120 мин',
        description: 'Мастер-класс по рисованию яблони Зиверса',
        speaker: 'Бриджит Хофер (Германия), OF "Алмалы Жумак"',
        type: 'workshop'
      },
      {
        id: 'art-3',
